...
namespace MYWFE.MVVM.ViewModel
{
    class SettingsViewModel : Core.ViewModel
    {
        ...
        #endregion
        public SettingsViewModel(HomeViewModel homeViewModel, IConfigurationService configurationService, IUserService userService, CustomModalViewModel customModal, DialogHostViewModel dialogHost, CustomMessageBoxViewModel customMessageBoxViewModel)
        {
